---
title: "Reproducilbe Research Project 1"
author: "Griffin Cook"
date: "8/5/2021"
...
## The mean and median of steps taken per day
```{r}
mean(total_steps_filled$steps, na.rm = T)
median(total_steps_filled$steps, na.rm = T)
```

The mean stayed the exact same, but because of the process I used the median has now become exactly equal to the mean.
